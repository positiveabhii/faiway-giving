...
import { Ticket, Settings, Zap, Play, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function AdminDrawsPage() {
  ...
  const handleSimulate = () => {
    ...
    setTimeout(() => {
      ...
      setSimulationResult(result.sort((a,b) => a-b));
          ...
          <div className="bg-charcoal-900 border border-white/5 rounded-xl p-6">
            ...
            <div className="mb-8">
              ...
              {logicMode === 'algorithmic' && (
                <p className="text-xs text-amber-500 mt-2 bg-amber-500/10 px-3 py-2 rounded inline-block border border-amber-500/20">
                  <AlertCircle size={14} className="inline mr-1" />
                  Warning: Algorithmic mode modifies natural variance. Ensure compliance with local sweepstakes regulations.
                </p>
              )}
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-charcoal-900 border border-white/5 rounded-xl p-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-2xl font-bold text-white">14,502</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Estimated Payout</p>
                <p className="text-2xl font-bold text-gold-400">$2,500,000</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-charcoal-900 border border-gold-500/20 rounded-xl p-6">
            ...
            <div className="bg-charcoal-950 p-4 rounded-lg border border-white/5 mb-4">
              ...
              <p className="text-lg font-bold text-white">$1,100,000</p>
            </div>
