        ...
        <div className="relative z-10">
          <GlassCard className="p-6 border-white/5 bg-black/20">
            <p className="text-gray-300 italic text-sm">
              "Joining this platform revolutionized my game. I play with purpose knowing I'm making a difference, and the potential payouts are unmatched."
            </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div 
                      ...
                      className={`cursor-pointer p-6 rounded-xl border-2 transition-all duration-300 ${plan === 'monthly' ? 'border-gold-500 bg-gold-500/10' : 'border-white/10 bg-charcoal-900/50 hover:border-white/30'}`}
                    >
                    ...
                    <div 
                      ...
                      className={`cursor-pointer p-6 rounded-xl border-2 relative overflow-hidden transition-all duration-300 ${plan === 'yearly' ? 'border-gold-500 bg-gold-500/10' : 'border-white/10 bg-charcoal-900/50 hover:border-white/30'}`}
                    >
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input type="password" required className="w-full bg-charcoal-900/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-gold-500/50" />
                  </div>
                </div>
              )}
            ...
            {step === 1 && (
              <div className="mt-6 text-center">
                <p className="text-gray-400 text-sm">
                  Already a member?{" "}
                  <Link href="/login" className="text-white font-medium hover:text-gold-400 transition-colors">
                    Sign In
                  </Link>
                </p>
              </div>
